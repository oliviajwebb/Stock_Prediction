...
MODEL_INFO = {
        ...
        "keys": ["AAPL", "MPWR", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": 0.0, "default": 0.0, "step": 10.0} for k in ["AAPL", "MPWR", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"]]
}
...
def display_explanation(input_df, session, aws_bucket):
    ...
    best_pipeline(session, aws_bucket, 'sklearn-pipeline-deployment')
    ...
    shap.plots.waterfall(shap_values[0,:,0], max_display=10) ##change depending on what youre predicting
    st.pyplot(fig)
    # top feature   
