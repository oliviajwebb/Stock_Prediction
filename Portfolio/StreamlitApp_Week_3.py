...
MODEL_INFO = {
        ...
        "keys": ["SBUX", "CMG", "YUM","DPZ", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["SBUX", "CMG", "YUM","DPZ", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"]]
}
